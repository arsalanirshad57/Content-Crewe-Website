...
const AboutCard = ({item}) => {
    return (
        <div className="border border-border_color flex flex-col justify-center items-center w-full h-40 gap-4 text-center my-2 sm:my-0 hover:border-blue transition-all duration-700 ">
