...
const AnimatedButton = ({ className, children , type }) => {
    return (
        <button type={type} className={`group relative cursor-pointer overflow-hidden  border rounded-md border-white px-6 py-2.5 hover:border-blue z-10 ${className} `}>
